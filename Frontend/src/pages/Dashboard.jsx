            ...
            <div className={HEADER}>
                <div className="min-w-0">
                    <h1 className="text-xl md:text-3xl font-bold text-gray-800 flex items-center gap-2">
                        <HomeIcon className="w-5 h-5 shrink-0 text-purple-500 md:w-6 md:h-6"></HomeIcon>
                        ...
                        <div key={key} className={`${borderColor} ${STAT_CARD}`}>
                            <div className="flex items-center gap-2 md:gap-3">
                                <div className={`${ICON_WRAPPER} ${iconColor}`}>
                                    <Icon className="w-4 h-4 md:w-5 md:h-5"></Icon>
                                </div>
                                ...
                                <div className="min-w-0">
                                    <p
                                        className={`${VALUE_CLASS} ${
                                            gradient
                                                ? "bg-gradient-to-r from-fuchsia-500 to bg-purple-600 bg-clip-text text-transparent"
                                                : textColor
                                        }`}
                                    >
                                        {stats[valueKey]}
                    ...
                    {filteredTasks.length == 0 ? (
                        <div className={EMPTY_STATE.wrapper}>
                            <div className={EMPTY_STATE.iconWrapper}>
                                <Calendar className="w-8 h-8 text-purple-500"></Calendar>
                            </div>
                            <h3 className="text-lg font-semibold text-gray-800 mb-2">No Task Founded</h3>
